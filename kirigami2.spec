...
Version  : 5.114.0
Release  : 80
URL      : https://download.kde.org/stable/frameworks/5.114/kirigami2-5.114.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.114/kirigami2-5.114.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.114/kirigami2-5.114.0.tar.xz.sig
...
%prep
%setup -q -n kirigami2-5.114.0
cd %{_builddir}/kirigami2-5.114.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705441340
mkdir -p clr-build
pushd clr-build
