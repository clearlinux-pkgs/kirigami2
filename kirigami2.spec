...
Version  : 5.107.0
Release  : 72
URL      : https://download.kde.org/stable/frameworks/5.107/kirigami2-5.107.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.107/kirigami2-5.107.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.107/kirigami2-5.107.0.tar.xz.sig
...
%prep
%setup -q -n kirigami2-5.107.0
cd %{_builddir}/kirigami2-5.107.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1686522839
mkdir -p clr-build
pushd clr-build
