...
Source0  : https://download.kde.org/stable/frameworks/5.111/kirigami2-5.111.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.111/kirigami2-5.111.0.tar.xz.sig
...
%prep
%setup -q -n kirigami2-5.111.0
cd %{_builddir}/kirigami2-5.111.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698080688
mkdir -p clr-build
pushd clr-build
