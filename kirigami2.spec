...
Source0  : https://download.kde.org/stable/frameworks/5.109/kirigami2-5.109.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.109/kirigami2-5.109.0.tar.xz.sig
...
%prep
%setup -q -n kirigami2-5.109.0
cd %{_builddir}/kirigami2-5.109.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1693020933
mkdir -p clr-build
pushd clr-build
