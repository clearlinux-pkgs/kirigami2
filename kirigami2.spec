...
Source0  : https://download.kde.org/stable/frameworks/5.110/kirigami2-5.110.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.110/kirigami2-5.110.0.tar.xz.sig
...
%prep
%setup -q -n kirigami2-5.110.0
cd %{_builddir}/kirigami2-5.110.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1694447027
mkdir -p clr-build
pushd clr-build
